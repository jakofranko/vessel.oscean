...
class Oscea
  ...
  class PassiveActions
    ...
    def answer q = "Home"
      ...
      if corpse.term.name.like("Unknown") then require_relative("../pages/missing.rb") ; return end
      ...
      if corpse.term.type && File.exist?("#{path}/modules/#{corpse.term.type.downcase}.rb") then require_relative("../modules/#{corpse.term.type.downcase}.rb") end
